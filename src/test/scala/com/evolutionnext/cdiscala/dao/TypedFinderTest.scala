...
//
//      val expectedResult: java.util.List[AccountJ] = List(
//        new AccountJ(13L, "Dan", "Hinojosa", "password"),
//        new AccountJ(14L, "Daniel", "Day Lewis", "password"),
//        new AccountJ(15L, "Daniel", "Radcliffe", "password")
//      )
//
...
//      mexpect(query.getResultList.asInstanceOf[java.util.List[AccountJ]]).andReturn(expectedResult)
//
//      replay(em, query)
...
//      mexpect(em.createQuery(queryString)).andReturn(query)
//      mexpect(query.setParameter("firstName", "Dan")).andReturn(query)
//      mexpect(query.getSingleResult.asInstanceOf[AccountJ]).andReturn(expectedResult)
//
//      replay(em, query)
//      val result = typedFinder.singleResult[AccountJ](map, queryString)
